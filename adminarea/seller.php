...
<!-- Navigation
    ...
    <div align="left" class="navbar-header">
      ...
      <li><a href="postad1.php" class="page-scroll">POST AD</a></li>
...
<div class="row">
			<div class="panel-body">
			    ...
			    <form action="cart.php" Method="POST">  					
				  ...
				  <tbody>
				  	<?php 
				  		$sql = "SELECT * FROM `cart`, `users` , `spare_part` WHERE spare_part.`id`=cart.`nauto_id` AND cart.`cust_id`=users.`user_id` AND cart.status='Confirmed' order by cart.id desc";
