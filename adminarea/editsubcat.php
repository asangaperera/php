...
if(isset($_SESSION['username']))
{
	...
	$sql = ("SELECT * FROM sub_menu WHERE id=$menuid");
...
<html>
<head>
<title>EDIT SUB CATEGORY PAGE</title>
...
<table border="0" cellpadding="1" cellspacing="0" width="100%">
  <tr>
    <td colspan="5" height="96">
		<form name="formRegister" method="post" action="confirmeditsubcat.php" onSubmit="return submitForms()">
            ...
            <td bgColor="c6d3ce">
			  ...
			  <tr bgColor="dee7e7">
			    ...
			    <tr bgColor="dee7e7">
                  ...
                  <td><b><input type="text" size="25" name="Mainid" onKeypress="if (event.keyCode < 45 || event.keyCode > 57) event.returnValue = false;" value="<?php echo $mainid; ?>"></b></td>
                </tr>
				<tr bgColor="dee7e7">
