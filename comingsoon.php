<?php
	...
	$sql = "SELECT COUNT(*) FROM nautoitem  WHERE type LIKE 'soon' ORDER BY id ASC";
	...
	$sql = " SELECT * FROM nautoitem WHERE type LIKE 'soon' ORDER BY id ASC";

	$query = mysqli_query($db_conx, $sql);
	// This shows the user what page they are on, and the total number of pages
	$textline1 = "Item (<b>$rows</b>)";
	...
	while($row = mysqli_fetch_array($query, MYSQLI_ASSOC))
	{
		...
		$list .='<li><a href="'. $src . $image . '"><img src="' . $src . $image . '" width="' . $width . '" height="' . $height . '" alt="' . $src . $prodname . '"/></a></li>'; // end list here
	}
