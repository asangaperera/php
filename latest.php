			...
			<div class="box-content-1">
				<div class="box-product-1" >
					<?php
						...
						$sql = "SELECT COUNT(*) FROM nautoitem WHERE prodname LIKE 'latest' ORDER BY id ASC";
						...
						$sql = " SELECT * FROM nautoitem WHERE prodname LIKE 'latest' ORDER BY id ASC $limit";

						$query = mysqli_query($db_conx, $sql);
						
						// This shows the user what page they are on, and the total number of pages
						$textline1 = "itemleries (<b>$rows</b>)";
						...
						else
						{
							...
							echo "<blockquote><b>" . $textline2 . "</b></blockquote>";
							echo $list;
