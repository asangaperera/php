...
<div id="wrapper">
	...
	<!-- Header Part Start-->
		...
		<!--Top Views Start-->
		<div class="box mb0" id="topsell">
			<div class="box-heading-1"><span>TOP SELLINGS</span></div>
			<div class="box-content-1">
				<div class="box-product-1" >
					<?php
						...
						$sql = "SELECT COUNT(*) FROM nautoitem WHERE topsell>0 ORDER BY topsell DESC";
						...
						$sql = " SELECT * FROM nautoitem WHERE topsell>0 ORDER BY topsell DESC $limit";
