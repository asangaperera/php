				...
				<div class="box-content-1">
					<div class="box-product-1" >
						<?php
							...
							$sql = "SELECT COUNT(*) FROM `main_menu`, sub_menu, nautoitem where main_menu.mmenu_id = sub_menu.mmenu_id and nautoitem.category = sub_menu.id and nautoitem.category = $item";
							...
							$sql = " SELECT * FROM `main_menu`, sub_menu, nautoitem where main_menu.mmenu_id = sub_menu.mmenu_id and nautoitem.category = sub_menu.id and nautoitem.category = $item $limit";
