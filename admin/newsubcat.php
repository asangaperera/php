...
<html>
<head>
<title>NEW SUB CATEGORY PAGE</title>
...
<p align="center"><b>NEW SUB CATEGORY PAGE</b></p>
        ...
        <tr>
            <td bgColor="c6d3ce">
              <table width="400" border="0">
				<tr bgColor="dee7e7">
                  <td width="165">Main ID</td>
                  <td><b><input type="text" size="25" placeholder="5" name="Mainid" onKeypress="if (event.keyCode < 45 || event.keyCode > 57) event.returnValue = false;"></b></td>
                </tr>
                <tr bgColor="dee7e7">
                  <td width="165">Name</td>
                  <td><b><input type="text" size="25" placeholder="Condition" name="Name" onkeypress="acceptw()"></b></td>
                </tr>
                <tr bgColor="e7efef">
                  <td>Link</td>
                  <td><b><input type="text" size="25" placeholder="viewproduct.php" name="Link"></b></td>
				</tr>
				</table>
            </td>
        </tr>
