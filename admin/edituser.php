...
var pw2 = document.forms[0].elements[5].value;
...
{
if (isName() && isSurname() &&isUsername() && isPassword() && isRpassword() && isEmail() && isAddress() && isTel() && isStatus() && isOK())
        ...
        <tr>
            <td bgColor="c6d3ce">
			  ...
			  <tr bgColor="dee7e7">
				...
				<tr bgColor="e7efef">
                  <td>Telephone</td>
                  <td><b><input type="text" size="10" maxlength="10" name="Tel" value="<?php echo $tel; ?>" onKeypress="if (event.keyCode < 45 || event.keyCode > 57) event.returnValue = false;"></b></td>
				</tr>				
				<tr bgColor="dee7e7">
                  <td>Acount Type</td>
