        ...
        <tr>
            <td bgColor="c6d3ce">
			  ...
			  <tr bgColor="dee7e7">
                ...
                <tr bgColor="e7efef">
                  <td>Price</td>
                  <td><b><input type="text" name="Price" size="25" value="Rs.<?php echo $price; ?>" onKeypress="if (event.keyCode < 45 || event.keyCode > 57) event.returnValue = false;"></b></td>
                </tr>
                <tr bgColor="e7efef">
                  <td>Quntity</td>
                  <td><b><input type="text" name="quntity" size="25" value="<?php echo $quntity; ?>" onKeypress="if (event.keyCode < 45 || event.keyCode > 57) event.returnValue = false;"></b></td>
                </tr>
                <tr bgColor="e7efef">
                  <td>Description</td>
