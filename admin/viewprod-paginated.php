...
<html>
<head>
<title>VIEW ITEMS RECORDS - PAGINATED</title>
...
<p align="center"><b>VIEW Item ITEMS RECORDS - PAGINATED</b></p>
...
<?php
        ...
        $result = mysql_query("SELECT * FROM nautoitem ORDER BY id DESC");
        ...
        echo "<tr> <th>ID</th> <th>Item NAME</th> <th>IMAGE PAGE</th> <th>CATEGORY</th> <th>PRICE</th> <th>DESCRIPTION</th> <th>TYPE</th> <th>VIEWS</th> <th>IMAGE</th> <th></th> <th></th></tr>";
        ...
        for ($i = $start; $i < $end; $i++)
        {
				...
				echo '<td>' . mysql_result($result, $i, 'image') . '</td>';
				...
				echo '<td><img src="' . $src . mysql_result($result, $i, 'image') . '" width="80px height="80"></td>';
