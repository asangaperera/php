...
<?php
        ...
        $result = mysql_query("SELECT * FROM spare_part WHERE type LIKE '$admin' ")  // CHECH
		
                or die(mysql_error());  
                
        // display data in table
        echo "<p><b>View All</b> | <a href='viewprod-paginated.php?page=1'>                </a> | <a href='postad.php'>Add a New Product</a></p>";
        
        echo "<table align='center' border='1' cellpadding='10'>";
		
		echo "<tr> <th>ID</th> <th>Item NAME</th> <th>IMAGE PAGE</th> <th>CATEGORY</th> <th>PRICE</th> <th>DESCRIPTION</th> <th>BRAND NAME</th> <th>VIEWS</th> <th>IMAGE</th> <th></th> <th></th></tr>";
