...
//$user_id=$row_seller['userid'];
  ...
  if (isset($_POST['upload'])) {
    ...
    $sql = "INSERT INTO nautoitem (image, descr,sp_make,prodname,price,category,topsell,seller_id,noviews,type,suggst_id) VALUES ('$image','$discription','$sp_make','$sp_name','$sp_price','$sp_category',1,'$userid',0,'$type',0)";
    // execute query
    mysqli_query($db, $sql);
