...
<?php
	...
	$selectproducts = "SELECT * FROM cart , nautoitem WHERE cart.cust_id = $userid AND nautoitem.id = cart.nauto_id AND checkout = 'n'";
...
<header id="headerWrapper">
	<div id="header" class="col-12">
		<div id="logo">
			<a href="index.php"><img src="image/logo.jpg" title="Nauto Logo" alt="Our Logo" /></a>
		</div>
		<!-- Mini Cart Start-->
		<div id="cart">
